...
apollo_initialise()
apollo_control= list (
  modelName = "mixedtimeinthet",
  modelDescr ="Mixed Logit with normal time interactions with all attributes and heteroscedasticity",
  indivID = "ID",
  mixing = TRUE, 
  HB=FALSE,
  nCores=11,
