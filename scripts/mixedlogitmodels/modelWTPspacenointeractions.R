...
apollo_initialise()
apollo_control= list (
  modelName = "modelWTPspacenointeractions",
  modelDescr ="Mixed Logit in willingness-to-pay space without Interaction Terms",
  indivID = "ID",
...
apollo_draws = list(
  ...
  interNormDraws = c("draws_asc_gemeinschaft",
                     ...
                     "draws_gestaltung",
                     "draws_beitrag"),
  # keine Intra-Individuen Heterogenität
...
modelWTPspacenointeractions = apollo_estimate(apollo_beta, apollo_fixed,
...
apollo_saveOutput(modelWTPspacenointeractions)
